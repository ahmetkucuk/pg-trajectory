...
ROW ( TIMESTAMP '2008-10-29 09:30:28', ST_GeomFromText('POINT(39.981814 116.322374)'))::tg_pair]::tg_pair[],
...
ROW ( TIMESTAMP '2008-11-03 10:16:01', ST_GeomFromText('POINT(39.996785 116.326341)'))::tg_pair]::tg_pair[],
'trajectory_table'::REGCLASS
);
...
ROW ( TIMESTAMP '2008-11-16 08:56:27', ST_GeomFromText('POINT(39.999497 116.323903)'))::tg_pair]::tg_pair[],
'trajectory_table'::REGCLASS
);
...
ROW ( TIMESTAMP '2008-11-17 05:18:33', ST_GeomFromText('POINT(39.998616 116.324511)'))::tg_pair]::tg_pair[],
'trajectory_table'::REGCLASS
);
