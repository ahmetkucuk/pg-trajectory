...
END
$BODY$
LANGUAGE 'plpgsql' ;DROP FUNCTION IF EXISTS t_equals( trajectory, trajectory );
...
END
$BODY$
LANGUAGE 'plpgsql';DROP FUNCTION IF EXISTS tg_end_time(tg_pair[]);
...
END
$BODY$
LANGUAGE 'plpgsql';DROP FUNCTION IF EXISTS t_union_area( trajectory, trajectory );
